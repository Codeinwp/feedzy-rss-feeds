describe('Test Free - Import Feed', function () {
  ...
  it('Create/Verify/Run import', function () {
    ...
    cy.get('#feedzy_post_terms')
      .invoke('show')
      .then(() => {
        cy.get('#feedzy_post_terms').select(feed.taxonomy, { force: true });
      });

    cy.get('[name="feedzy_meta_data[import_post_title]"]')
      .scrollIntoView()
      .clear()
      .type(PREFIX + feed.title, { force: true });
    cy.get('[name="feedzy_meta_data[import_post_content]"]')
      .scrollIntoView()
      .clear()
      .type(PREFIX + feed.fullcontent.content + feed.content, { force: true });

    // image from URL
    cy.get('[name="feedzy_meta_data[import_post_featured_img]"]')
      .scrollIntoView()
      .clear()
      .type(feed.image.url, { force: true });
  ...
  it('Update the new import with VALID url', function () {
    ...
    cy.get('[name="feedzy_meta_data[import_post_title]"]').should(
      'have.value',
      PREFIX + feed.title,
    );
    cy.get('[name="feedzy_meta_data[import_post_content]"]').should(
      'have.value',
      PREFIX + feed.fullcontent.content + feed.content,
    );

    // image from URL
    cy.get('[name="feedzy_meta_data[import_post_featured_img]"]').should(
      'have.value',
      feed.image.url,
    );
    ...
    cy.visit('/edit.php?post_type=feedzy_imports');
    cy.get('tr:nth-of-type(1) .feedzy-toggle').should('not.be.visible');
    ...
    cy.get(
      'table.posts:nth-of-type(1) tr.feedzy-import-status-row td:nth-of-type(1) table tr:nth-of-type(1) td:nth-of-type(1)',
    )
      .invoke('data', 'value')
      .should(($value) => {
    ...
    cy.get(
      'table.posts:nth-of-type(1) tr.feedzy-import-status-row td:nth-of-type(1) table tr:nth-of-type(1) td:nth-of-type(2)',
    )
      .invoke('data', 'value')
      .should(($value) => {
    ...
    cy.get(
      'table.posts:nth-of-type(1) tr.feedzy-import-status-row td:nth-of-type(1) table tr:nth-of-type(1) td:nth-of-type(3)',
    )
      .invoke('data', 'value')
      .should(($value) => {
    ...
    cy.get(
      'table.posts:nth-of-type(1) tr.feedzy-import-status-row td:nth-of-type(1) table tr:nth-of-type(1) td:nth-of-type(4)',
    )
      .invoke('data', 'value')
      .should(($value) => {
    ...
    cy.get(
      'table.posts:nth-of-type(1) tr.feedzy-import-status-row td:nth-of-type(1) table tr:nth-of-type(1) td:nth-of-type(5)',
    )
      .invoke('data', 'value')
      .should(($value) => {
    ...
    cy.get(
      ...
      .invoke('html')
      .should('include', 'Importing');
    cy.wait(20 * parseInt(feed.wait));
    cy.get(
      'table.posts:nth-of-type(1) tr.feedzy-import-status-row td:nth-of-type(1) table tr:nth-of-type(1) td:nth-of-type(1)',
    )
      .invoke('html')
      .should('include', 'Successfully run');
    ...
    cy.get(
      ...
      .invoke('html')
      .should('include', 'Nothing imported');
    ...
    cy.get(
      'table.posts:nth-of-type(1) tr.feedzy-import-status-row td:nth-of-type(1) table tr:nth-of-type(1) td:nth-of-type(4) a',
    )
      .first()
      .click();
    ...
    cy.get('table.posts tbody tr td a.row-title:contains("item_custom_")').should(
      'have.length',
      feed.items,
    );
    ...
    cy.get('table.posts tbody tr td.author:contains("wordpress")').should(
      'have.length',
      feed.items,
    );

    // click to view post
    cy.get('table.posts tbody tr td a.row-title')
      .first()
      .parent()
      .parent()
      .find('span.view a')
