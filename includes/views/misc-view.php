		...
		<div class="fz-form-group">
			...
			<div class="help-text">
				<?php
					...
					echo wp_kses_post( sprintf( __( 'Check the <a href="%s" targer="_blank">Documentation</a> for more details.', 'feedzy-rss-feeds' ), esc_url( 'https://docs.themeisle.com/category/712-feedzy' ) ) );
				?>
			</div>
		</div>
	</div>
