...
<div class="f1" id="feedzy-import-form">
	...
	<h3><span class="dashicons dashicons-feedback"></span> <?php esc_html_e( 'Assign Elements', 'feedzy-rss-feeds' ); ?></h3>
		...
		<div class="feedzy-rows">
			...
			<div class="feedzy-row">
				<div class="label_description">
					<label class="feedzy-sr-only" for="f1-post-content"><?php echo esc_attr__( 'External Image URL?', 'feedzy-rss-feeds' ); ?></label><br/>
					<small>
						<?php
				...
				<div class="form-group input-group form_item">
					<div>
						...
						<label class="feedzy-inline" style="margin-left: 10px;" for="import_use_external_image"><?php esc_attr_e( 'User external image URL, Ignore feature post thumbnail', 'feedzy-rss-feeds' ); ?></label>
					</div>
				</div>
			</div>
			<div class="feedzy-row">
