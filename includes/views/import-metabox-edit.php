						...
						<div class="fz-input-group">
							<div class="fz-input-group-left">
								<div class="fz-group">
									...
									<div class="cta">
										<a class="btn btn-flate" id="feedzy-validate-feed" target="_blank" data-href-base="https://validator.w3.org/feed/check.cgi?url="
											href="#" title="<?php esc_attr_e( 'Validate Feed', 'feedzy-rss-feeds' ); ?>"><?php esc_html_e( 'Validate', 'feedzy-rss-feeds' ); ?></a>
									</div>
								</div>
								<div class="help-text">
