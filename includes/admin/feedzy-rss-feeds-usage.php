...
class Feedzy_Rss_Feeds_Usage {
    ...
    public function get_usage_stats() {
        ...
        $stats = array(
            'first_import_run_datetime' => !empty($data['first_import_run_datetime']) ?
                $data['first_import_run_datetime'] : 'Never',
            'import_runs' => $data['imports_runs'],
            'first_import_created_datetime' => !empty($data['first_import_created_datetime']) ?
                $data['first_import_created_datetime'] : 'Never',
        );
        ...
        if (!empty($data['first_import_run_datetime']) && !empty($data['first_import_created_datetime'])) {
            ...
            if ( $settings_time > $import_time ) {
                $time_diff = $settings_time - $import_time;
                $stats['time_between_first_import_created_and_run'] = $time_diff;
            }
        }
