	...
	public function add_import_actions( $actions, $post ) {
		if ( 'feedzy_imports' === $post->post_type ) {
			...
			$export_action = sprintf(
				...
				( ! feedzy_is_pro() ? esc_html__( 'Export', 'feedzy-rss-feeds' ) . '<span style="font-size: 13px;line-height: 1.5em;width: 13px;height: 13px;" class="dashicons dashicons-lock"></span>' : esc_html__( 'Export', 'feedzy-rss-feeds' ) )
			);
