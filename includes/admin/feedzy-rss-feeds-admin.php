	...
	private function save_settings() {
		...
		switch ( $post_tab ) {
			case 'general':
				...
				$settings['general']['in-built-text-rewriter'] = isset( $_POST['in-built-text-rewriter'] ) ? (int) filter_input( INPUT_POST, 'in-built-text-rewriter', FILTER_SANITIZE_NUMBER_INT ) : '';
